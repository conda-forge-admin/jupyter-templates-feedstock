About jupyter-templates-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter-templates-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter-templates-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-templates jupyter_templates
# for installing globally
pixi global install jupyter-templates jupyter_templates
```
...
It is possible to list all of the versions of `jupyter-templates` available on your platform:
...
```
pixi search jupyter-templates --channel conda-forge
```
